...
angular
  .module('firstWixAngularAppInternal', []);
...
angular
  .module('firstWixAngularApp', ['firstWixAngularAppInternal', 'firstWixAngularTranslations', 'firstWixAngularPreload', 'wixAngular', 'wix.common.bi'])
  .config(function () {
    return;
  });
