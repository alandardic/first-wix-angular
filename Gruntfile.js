// Generated on 2015-07-01 using generator-wix-angular 0.1.130
'use strict';
...
module.exports = function (grunt) {
  require('wix-gruntfile')(grunt, {
    cdnify: 'vm',
    port: 9000,
    preloadModule: 'firstWixAngularPreload',
    translationsModule: 'firstWixAngularTranslations',
    svgFontName: 'first-wix-angular',
